  ...
  return (
    <div className="skills-container">
      <div className="skills-description">
        ...
        <p>Experienced in back-end development using PHP and Laravel framework, with the ability to create robust and scalable web applications. Proficient in database management with MySQL, ensuring efficient data storage and retrieval.</p>
        ...
        <p>Currently exploring ReactJS for building dynamic and interactive web applications.</p>
      </div>
